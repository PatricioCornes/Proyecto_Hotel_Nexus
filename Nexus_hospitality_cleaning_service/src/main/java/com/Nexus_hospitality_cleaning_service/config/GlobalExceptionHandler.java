...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> unavailable(RestClientException ex, HttpServletRequest req) {
        return response(HttpStatus.SERVICE_UNAVAILABLE, "DEPENDENCY_UNAVAILABLE", "El servicio de personal no está disponible", req, Map.of());
    }
